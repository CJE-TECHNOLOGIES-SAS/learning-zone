    ...
    return (
        <>
            ...
            {clickMoreOptions?
                ...
                <h3 className="options-title">Configuración de privacidad</h3>
                <p className="options-description">
                    Selecciona qué tipos de cookies deseas permitir. Puedes cambiar estas preferencias en cualquier momento.
                </p>
                ...
                <form className="options-form">
                    ...
                    <label className="option-item">
                    <input type="checkbox" />
                    Cookies analíticas (mejoran la experiencia de uso)
                    </label>

                    <label className="option-item">
                    <input type="checkbox" />
                    Cookies de marketing (contenido personalizado y anuncios)
                    </label>
                </form>
                ...
                <div className="options-actions">
                    ...
                    <button className="btn-cancel" type="button" onClick={() => setClickMoreOptions(false)}>
                    Cancelar
                    </button>
                </div>
                </div>
