...
import "./styles/CircularGalery.css";
...
addEventListeners() {
  ...
  // SOLO resize se queda en window
  window.addEventListener("resize", this.boundOnResize);

  // LOS DEMÁS SE ESCUCHAN SOLO EN EL CONTENEDOR
...
/* type CircularGalleryProps = {
  images: { src: string }[];       // <- asegúrate de que exista esta línea
  bend: number;
  textColor: string;
  borderRadius: number;
}; */
